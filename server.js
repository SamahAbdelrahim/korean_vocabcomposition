...
const koreanvars = require('./variables/variables-logger.js'); // Import the model
...
app.post('/api/log', (req, res) => {
    ...
    const newLog = new koreanvars({ rt, trial_type, trial_index, time_elapsed, internal_node_id, subject, response, theword, block, study_id, session_id });
